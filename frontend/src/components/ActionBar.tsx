      ...
      <div className="flex items-center gap-2">
        ...
        {onShowSolution && (
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-slate-300 bg-slate-50 px-3 py-2 text-xs font-semibold text-slate-700 transition hover:bg-slate-100"
          >
